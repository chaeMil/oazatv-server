/* http://www.x-tags.org/download?byob=,WeakMap,MutationObserver,domtokenlist-polyfill,customelements-polyfill,x-tag-core,x-tag-mixin-request,htmlimports-polyfill */ 
...
(function() {
    ...
    function request(element, options) {
        ...
        var request = element.xtag.request, callbackKey = (element.getAttribute("data-callback-key") || "callback") + "=xtag.callbacks.";
    ...
    function requestCallback(element, request) {
        ...
        xtag.fireEvent(element, "dataready", {
            request: request
        });
